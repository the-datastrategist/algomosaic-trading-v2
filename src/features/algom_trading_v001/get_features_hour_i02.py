...
#     df = talib.EMA(df, 200)
    ...
    # volume indicators
    df = talib.AROR(df, 1, VOLUME)
    df = talib.AROR(df, 3, VOLUME)
    df = talib.AROR(df, 5, VOLUME)
    df = talib.AROR(df, 10, VOLUME)
    df = talib.AROR(df, 15, VOLUME)
    df = talib.AROR(df, 20, VOLUME)
    df = talib.AROR(df, 25, VOLUME)
    df = talib.AROR(df, 50, VOLUME)
    df = talib.AROR(df, 100, VOLUME)
    df = talib.AROR(df, 200, VOLUME)
