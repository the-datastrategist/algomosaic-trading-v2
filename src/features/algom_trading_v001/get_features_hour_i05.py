...
def get_features(df):
    ...
    # Lag 3 AROR; to determine if incr or decr
    df = talib_features.LAG(df, 'AROR_3', 1)
    df = talib_features.LAG(df, 'AROR_3', 2)
    df = talib_features.LAG(df, 'AROR_3', 3)

    df = talib_features.LAG(df, 'AROR_6', 1)
    df = talib_features.LAG(df, 'AROR_6', 2)
    df = talib_features.LAG(df, 'AROR_6', 3)

    df = talib_features.LAG(df, 'AROR_9', 1)
    df = talib_features.LAG(df, 'AROR_9', 2)
    df = talib_features.LAG(df, 'AROR_9', 3)

    df = talib_features.LAG(df, 'AROR_12', 1)
    df = talib_features.LAG(df, 'AROR_12', 2)
    df = talib_features.LAG(df, 'AROR_12', 3)

    df = talib_features.LAG(df, 'AROR_24', 1)
    df = talib_features.LAG(df, 'AROR_24', 2)
    df = talib_features.LAG(df, 'AROR_24', 3)
...
#     df = talib.BBANDS(df, 240)
    ...
    # Lag3 Bollinger % Bands; determine incr or desc
#     df = talib_features.LAG(df, 'Bollinger%_b_24', 3)
#     df = talib_features.LAG(df, 'Bollinger%_b_48', 3)
#     df = talib_features.LAG(df, 'Bollinger%_b_96', 3)
...
#     df = talib.Vortex(df, n=168)
    ...
    df = talib_features.SM_MIN(df, n=72)
    ...
    df = talib_features.SM_MAX(df, n=72)
